...
- 📊 Passionate and detail-oriented **Data Analyst** with expertise in transforming complex datasets into actionable business insights  
- 📈 Skilled in **Data Analysis, Data Cleaning, Data Visualization, and Business Intelligence**  
- 🧠 Proficient in **Python, SQL, Excel, Power BI, Tableau, and Statistical Analysis**  
- 🚀 Continuously learning **Machine Learning, Predictive Analytics, and Advanced Analytics**  
- 💡 Strong problem-solving mindset with the ability to convert raw data into meaningful visual stories  
